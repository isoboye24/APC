...
namespace APC.AllForms
{
    public partial class FormReportsBoard : Form
    {
        ...
        private void FormReportsBoard_Load(object sender, EventArgs e)
        {
            ...
            labelTotalFinReport.Font = new Font("Segoe UI", 10, FontStyle.Regular);
            ...
            txtYearFinReport.Font = new Font("Segoe UI", 12, FontStyle.Regular);
            btnAddFinReport.Font = new Font("Segoe UI", 12, FontStyle.Bold);
            btnUpdateFinReport.Font = new Font("Segoe UI", 12, FontStyle.Bold);
            btnViewFinReport.Font = new Font("Segoe UI", 12, FontStyle.Bold);
            btnDeleteFinReport.Font = new Font("Segoe UI", 12, FontStyle.Bold);

            label1.Font = new Font("Segoe UI", 12, FontStyle.Bold);
            label4.Font = new Font("Segoe UI", 12, FontStyle.Bold);
            labelTotalExpReport.Font = new Font("Segoe UI", 10, FontStyle.Regular);
            cmbMonthExpReport.Font = new Font("Segoe UI", 12, FontStyle.Regular);
            btnAddExpReport.Font = new Font("Segoe UI", 12, FontStyle.Bold);
            btnUpdateExpReport.Font = new Font("Segoe UI", 12, FontStyle.Bold);
            btnViewExpReport.Font = new Font("Segoe UI", 12, FontStyle.Bold);
            btnDeleteExpReport.Font = new Font("Segoe UI", 12, FontStyle.Bold);
            btnSearchExpReport.Font = new Font("Segoe UI", 12, FontStyle.Bold);
            btnClearExpReport.Font = new Font("Segoe UI", 12, FontStyle.Bold);
            #endregion
